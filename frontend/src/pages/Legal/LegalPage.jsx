...
const LegalPage = () => {
  ...
  useEffect(() => {
    ...
    if (paymentStatus === 'success') {
      ...
      alert('Payment successful! Your legal service submission has been confirmed.');
      // Switch to status tab to show updated submissions
      setActiveTab('status');
      // Clean URL
        ...
        {(activeTab === 'services' || !activeTab || activeTab === '') && (
          <div className="max-w-6xl mx-auto">
            ...
            {isLoading ? (
              ...
              <div className="col-span-full text-center py-12">
                <p className="text-gray-600">No legal services are available right now.</p>
                <p className="text-sm text-gray-500 mt-2">We’ll update this section as soon as new services are published.</p>
                {error && (
              ...
              (() => {
                ...
                return validServices.map((service, index) => {
                  const description =
                    service.description ||
                    service.shortDescription ||
                    'Professional legal assistance tailored for your business needs.';
                  ...
                  return (
                    ...
                    >
                      <Link to={`/legal/service/${service.id}`} className="block h-full">
                        <div className="relative bg-white rounded-2xl p-0 shadow-md border border-gray-200 overflow-hidden h-full flex flex-col min-h-[150px] md:min-h-[200px] transition-all duration-300 group-hover:shadow-lg group-hover:-translate-y-1">
                          ...
                          <div className="relative flex-shrink-0">
                            ...
                            >
                              <div className={`w-full h-full bg-gradient-to-br ${service.color || 'from-blue-500 to-indigo-500'} flex items-center justify-center`}>
                                <span className="text-3xl md:text-4xl text-white drop-shadow">{service.icon || '⚖️'}</span>
                              </div>
                            </motion.div>
                          </div>

                          {/* Content */}
                          <div className="relative z-10 flex flex-col flex-grow min-h-0 p-3">
                            <motion.h3
                              whileHover={{ x: 1 }}
                              className="font-semibold text-gray-900 text-xs md:text-sm mb-1 line-clamp-2 flex-shrink-0 min-h-[32px] md:min-h-[40px]"
                            >
                              {service.name || 'Legal Service'}
                            </motion.h3>

                            <div className="h-[28px] md:h-[32px] mb-2 flex-shrink-0">
                            ...
                            <div className="flex items-center justify-between pt-1 md:pt-1.5 border-t border-gray-100 mt-auto flex-shrink-0">
                              <span className="text-[10px] md:text-xs font-semibold text-blue-600 uppercase tracking-wide">
                                Get Started
                              </span>
                              <motion.div
                                whileHover={{ scale: 1.1, rotate: 5 }}
                                whileTap={{ scale: 0.95 }}
                                className="relative w-8 h-8 md:w-10 md:h-10 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden"
                              >
