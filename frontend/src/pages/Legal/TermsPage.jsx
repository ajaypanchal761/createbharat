            ...
            <div className="max-w-4xl mx-auto px-3 md:px-4 py-4 md:py-8">
                ...
                >
                    <div className="text-center mb-4 md:mb-8">
                        <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-2 md:mb-4">Terms & Conditions</h1>
                        <p className="text-sm md:text-base text-gray-600">Welcome to CreateBharat, a digital platform powered by CreateBharat Foundation</p>
                    </div>
                    ...
                    <div className="prose prose-sm md:prose-lg max-w-none">
                        ...
                        <motion.section
                            ...
                            className="mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">1️⃣ General Terms & User Agreement</h2>
                            
                            <h3 className="text-base md:text-xl font-semibold text-gray-900 mb-2 md:mb-3 mt-3 md:mt-4">1.1 By registering or using CreateBharat, you confirm that:</h3>
                            ...
                            <p className="text-xs md:text-base text-gray-700 leading-relaxed mb-2 md:mb-3 mt-3 md:mt-4">
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">2️⃣ Services Overview</h2>
                            <p className="text-xs md:text-base text-gray-700 leading-relaxed mb-2 md:mb-3">CreateBharat offers multiple services through its app and website, including but not limited to:</p>
                            <ul className="list-disc list-inside text-xs md:text-base text-gray-700 space-y-1 md:space-y-2 mb-3 md:mb-4 ml-3 md:ml-4">
                            ...
                            <p className="text-xs md:text-base text-gray-700 leading-relaxed mb-3 md:mb-4 mt-3 md:mt-4">
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">3️⃣ User Responsibilities & Code of Conduct</h2>
                            
                            <h3 className="text-base md:text-xl font-semibold text-gray-900 mb-2 md:mb-3 mt-3 md:mt-4">3.1 Users agree not to misuse the app or engage in activities that may:</h3>
                            <ul className="list-disc list-inside text-xs md:text-base text-gray-700 space-y-1 md:space-y-2 mb-3 md:mb-4 ml-3 md:ml-4">
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">4️⃣ Payments, Refunds & Subscriptions</h2>
                            ...
                            <h3 className="text-base md:text-xl font-semibold text-gray-900 mb-2 md:mb-3 mt-3 md:mt-4">4.3 Refund Policy:</h3>
                            <ul className="list-disc list-inside text-xs md:text-base text-gray-700 space-y-1 md:space-y-2 mb-3 md:mb-4 ml-3 md:ml-4">
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">5️⃣ Data Privacy, Security & Intellectual Property</h2>
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">6️⃣ Limitation of Liability & Dispute Resolution</h2>
                            
                            <h3 className="text-base md:text-xl font-semibold text-gray-900 mb-2 md:mb-3 mt-3 md:mt-4">6.1 CreateBharat Foundation and its affiliates shall not be liable for:</h3>
                            <ul className="list-disc list-inside text-xs md:text-base text-gray-700 space-y-1 md:space-y-2 mb-3 md:mb-4 ml-3 md:ml-4">
                            ...
                            <h3 className="text-base md:text-xl font-semibold text-gray-900 mb-2 md:mb-3 mt-3 md:mt-4">6.2 In case of any dispute:</h3>
                            <ul className="list-disc list-inside text-xs md:text-base text-gray-700 space-y-1 md:space-y-2 mb-3 md:mb-4 ml-3 md:ml-4">
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">7️⃣ Communication & Support</h2>
                            <p className="text-xs md:text-base text-gray-700 leading-relaxed mb-2 md:mb-3">You may receive notifications via email, SMS, or in-app alerts regarding:</p>
                            <ul className="list-disc list-inside text-xs md:text-base text-gray-700 space-y-1 md:space-y-2 mb-3 md:mb-4 ml-3 md:ml-4">
                            ...
                            <p className="text-xs md:text-base text-gray-700 leading-relaxed mb-2 md:mb-3 mt-3 md:mt-4">For any support, contact:</p>
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">8️⃣ Termination of Access</h2>
                            <p className="text-xs md:text-base text-gray-700 leading-relaxed mb-2 md:mb-3">CreateBharat reserves the right to suspend or delete user accounts that:</p>
                            <ul className="list-disc list-inside text-xs md:text-base text-gray-700 space-y-1 md:space-y-2 mb-3 md:mb-4 ml-3 md:ml-4">
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">9️⃣ Governing Law</h2>
                            <p className="text-xs md:text-base text-gray-700 leading-relaxed mb-3 md:mb-4">
                        ...
                        <motion.section
                            ...
                            className="mb-4 md:mb-8"
                        >
                            <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">🔟 Acceptance of Terms</h2>
                            <p className="text-xs md:text-base text-gray-700 leading-relaxed mb-3 md:mb-4">
