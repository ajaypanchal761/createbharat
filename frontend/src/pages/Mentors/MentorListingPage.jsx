          ...
          <div className="md:hidden flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">{filteredMentors.length} mentors available</p>
              </div>
            </div>
            <button
              onClick={() => navigate('/mentors/login')}
              className="px-3 py-1.5 bg-orange-600 text-white font-semibold rounded-lg hover:bg-orange-700 transition-colors text-xs"
            >
              Mentor Login
            </button>
          </div>
