...
import { authAPI, pitchAPI } from '../../utils/api';
...
const ProfilePage = () => {
    ...
    // Check if user is logged in (must be defined before useEffects)
    ...
    const handleImageChange = async (e) => {
        ...
        try {
            ...
            // Check if user no longer exists - logout and redirect
            if (error.message && error.message.includes('user no longer exists')) {
                // Clear all auth data
    ...
    if (userLoading) {
        return (
            <div className="min-h-screen bg-gray-50 pb-32 md:pb-20 flex items-center justify-center">
                        ...
                        <div className="bg-white rounded-2xl md:rounded-3xl shadow-lg overflow-hidden">
                            <div className="p-3 md:p-6">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Link to="/pitch/submit" className="flex items-center justify-between p-3 md:p-4 hover:bg-gray-50 rounded-lg md:rounded-xl transition-colors">
                                        <div className="flex items-center space-x-3 md:space-x-4">
                                            <div className="w-8 h-8 md:w-10 md:h-10 bg-orange-100 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0">
                                                <svg className="w-4 h-4 md:w-6 md:h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                            ...
                                            <span className="text-sm md:text-base text-gray-800 font-medium">Submit Your Pitch</span>
                                        </div>
                                        <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                        </svg>
