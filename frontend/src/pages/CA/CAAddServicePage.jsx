...
const CAAddServicePage = () => {
  ...
  const colorOptions = [
    ...
    { value: 'from-green-500 to-emerald-500', label: 'Green to Emerald恩' },
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="turn" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <h1 className="text-2xl font-bold text-gray-900">Add New Legal Service</h1>
          </div>
        </motion.div>
...
export default CAAddServicePage;
