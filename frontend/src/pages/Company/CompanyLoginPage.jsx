...
const CompanyLoginPage = () => {
  ...
  return (
    <motion.div 
      ...
      className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100 flex items-center justify-center p-0 sm:p-4"
    >
      <div className="w-full max-w-full sm:max-w-md bg-white shadow-xl sm:shadow-2xl overflow-hidden rounded-none sm:rounded-2xl min-h-screen sm:min-h-0 flex flex-col">
        {/* Header Section */}
