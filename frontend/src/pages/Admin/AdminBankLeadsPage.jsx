                                            ...
                                            <td className="px-4 py-3 whitespace-nowrap">
                                                ...
                                                {lead.accountType && (
                                                    <div className="text-xs text-blue-600 font-semibold mt-1">
                                                        {lead.accountType === 'savings' ? 'Savings Account' : lead.accountType === 'current' ? 'Current Account' : `Account: ${lead.accountType}`}
                                                    </div>
                                                )}
                                                {lead.businessType && (
                                                    <div className="text-xs text-gray-500">
                                                        Business: {lead.businessType.charAt(0).toUpperCase() + lead.businessType.slice(1)}
                                                    </div>
                                                )}
                                                {lead.hasPanCard === 'yes' && lead.panNumber && (
                                                    <div className="text-[11px] text-gray-500">PAN: {lead.panNumber}</div>
                                                )}
                                                {lead.hasGst === 'yes' && lead.gstNumber && (
                                                    <div className="text-[11px] text-gray-500">GST: {lead.gstNumber}</div>
                                                )}
                                            </td>
                                            <td className="px-4 py-3 whitespace-nowrap">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base text-gray-900 mt-1 capitalize">
                                                {selectedLead.accountType ? (selectedLead.accountType === 'savings' ? 'Savings Account' : selectedLead.accountType === 'current' ? 'Current Account' : selectedLead.accountType) : 'N/A'}
                                            </p>
                                        </div>
                                        <div>
                            ...
                            <div>
                                <h4 className="text-lg font-bold text-gray-900 mb-4">Identification Details</h4>
                                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                                    <div>
                                        <span className="text-sm font-medium text-gray-600">Aadhaar Number:</span>
                                        <p className="text-base text-gray-900 mt-1">
                                            {selectedLead.aadhaarNumber || 'N/A'}
                                        </p>
                                    </div>
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <p className="text-base text-gray-900 mt-1">
                                                {selectedLead.hasPanCard ? selectedLead.hasPanCard.toUpperCase() : 'N/A'}
                                                {selectedLead.panNumber ? ` • ${selectedLead.panNumber}` : ''}
                                            </p>
                                        </div>
                                        <div>
                                            <span className="text-sm font-medium text-gray-600">GST Registration:</span>
                                            <p className="text-base text-gray-900 mt-1">
                                                {selectedLead.hasGst ? selectedLead.hasGst.toUpperCase() : 'N/A'}
                                                {selectedLead.gstNumber ? ` • ${selectedLead.gstNumber}` : ''}
                                            </p>
                                        </div>
                                        <div>
                                            <span className="text-sm font-medium text-gray-600">Udyam/MSME Certificate:</span>
                                            <p className="text-base text-gray-900 mt-1">
                                                {selectedLead.hasUdyamMsmeCertificate ? selectedLead.hasUdyamMsmeCertificate.toUpperCase() : 'N/A'}
                                                {selectedLead.udyamMsmeNumber ? ` • ${selectedLead.udyamMsmeNumber}` : ''}
                                            </p>
                                        </div>
                                    </div>
                                </div>
