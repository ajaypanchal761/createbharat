...
const AdminDashboard = () => {
            ...
            try {
                ...
                if (response.success) {
                    setStats({
                        ...
                        totalDevelopmentLeads: response.data.stats.totalDevelopmentLeads || 0,
                        totalBankLeads: response.data.stats.totalBankLeads || 0
                    });
    ...
    const handleCardClick = (cardType) => {
        switch(cardType) {
            ...
            case 'mentors':
                ...
                break;
            case 'developmentLeads':
                navigate('/admin/leads');
                break;
            case 'bankLeads':
                navigate('/admin/bank-leads');
                break;
            default:
                break;
        }
    ...
    const kpiCards = [
        ...
        },
        {
            ...
            value: stats.totalDevelopmentLeads.toLocaleString(),
            trend: 'up',
            icon: FaEnvelope,
            color: 'from-orange-500 to-orange-600',
            bgColor: 'bg-orange-50',
            textColor: 'text-orange-600',
            route: 'developmentLeads'
        },
        {
            title: 'Bank Leads',
            value: stats.totalBankLeads.toLocaleString(),
            trend: 'up',
            icon: FaUniversity,
