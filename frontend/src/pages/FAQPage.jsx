            ...
            <div className="max-w-4xl mx-auto px-3 md:px-4 py-4 md:py-8">
                ...
                >
                    <div className="text-center mb-4 md:mb-8">
                        <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-2 md:mb-4">Frequently Asked Questions</h1>
                        <p className="text-sm md:text-base text-gray-600">Find answers to common questions about CreateBharat</p>
                    </div>
                        ...
                        {faqs.map((faq, index) => (
                            ...
                            >
                                <button
                                    ...
                                    className="w-full px-3 md:px-6 py-3 md:py-4 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors"
                                >
                                    <span className="font-semibold text-sm md:text-base text-gray-900 pr-2">{faq.question}</span>
                                    <svg
                                        className={`w-4 h-4 md:w-5 md:h-5 text-gray-600 transition-transform flex-shrink-0 ${openIndex === index ? 'rotate-180' : ''}`}
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                    >
                                ...
                                {openIndex === index && (
                                    <motion.div
                                        ...
                                        className="px-3 md:px-6 py-3 md:py-4 bg-white"
                                    >
                    ...
                    <motion.div
                        ...
                        className="text-center mt-4 md:mt-8 pt-4 md:pt-8 border-t border-gray-200"
                    >
                        <p className="text-sm md:text-base text-gray-600 mb-3 md:mb-4">Still have questions?</p>
                        <Link 
                            to="/contact" 
                            className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2 md:py-3 px-6 md:px-8 rounded-lg md:rounded-xl text-sm md:text-base font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-300"
                        >
                            Contact Us
                        </Link>
                    </motion.div>
