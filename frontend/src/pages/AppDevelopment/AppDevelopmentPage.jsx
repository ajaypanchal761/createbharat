            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-orange-50 via-white to-blue-50 md:from-orange-50/80 md:via-white md:to-blue-50/80">
                ...
                <div className="px-4 md:max-w-7xl md:mx-auto md:px-6 lg:px-8 py-8 md:py-12">
                    <motion.div
                        ...
                        className="bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 shadow-2xl text-center"
                    >
                        <div className="max-w-2xl mx-auto">
                            ...
                            <p className="text-white/90 text-base md:text-lg mb-6">
                                Submit your pitch and get the support you need to turn your idea into reality
                            </p>
                            <motion.button
                                whileHover={{ scale: 1.05, y: -2 }}
                                whileTap={{ scale: 0.95 }}
                                onClick={() => {
                                    if (isAuthenticated()) {
                                        navigate('/pitch/submit');
                                    } else {
                                        navigate('/login');
                                    }
                                }}
                                className="px-8 py-4 bg-white text-purple-600 font-bold rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 text-base md:text-lg"
                            >
                                Submit Your Pitch
                            </motion.button>
                        </div>
            ...
            {showProjectForm && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-white rounded-none md:rounded-2xl lg:rounded-3xl w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-3xl overflow-y-auto shadow-2xl flex flex-col"
                        ...
                        <form onSubmit={handleProjectSubmit} className="flex-1 px-3 sm:px-6 lg:px-8 py-3 sm:py-5 space-y-3 sm:space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full px-3 py-2 sm:py-2.5 border border-gray-300 rounded-none md:rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all text-xs sm:text-sm"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                    rows={3}
                                    className="w-full px-3 py-2 sm:py-2.5 border border-gray-300 rounded-none md:rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all text-xs sm:text-sm resize-none"
                            ...
                            <div className="sticky bottom-0 bg-white border-t border-gray-200 -mx-3 sm:-mx-6 lg:-mx-8 px-3 sm:px-6 lg:px-8 py-3 sm:py-4 flex flex-col sm:flex-row gap-2 sm:gap-3">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.99 }}
                                    onClick={() => setShowProjectForm(false)}
                                    className="flex-1 px-4 py-2 sm:py-2.5 bg-gray-100 text-gray-700 font-semibold rounded-none md:rounded-lg hover:bg-gray-200 transition-all duration-300 text-xs sm:text-sm"
                                >
                                    Cancel
                                </motion.button>
                                <motion.button
                                    ...
                                    className={`flex-1 px-4 py-2 sm:py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold rounded-none md:rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-xs sm:text-sm ${
