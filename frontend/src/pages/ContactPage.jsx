                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">support@createbharat.com</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">+91-XXX-XXXX-XXXX</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">CreateBharat Headquarters, India</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
