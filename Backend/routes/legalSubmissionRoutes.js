...
router.post('/submissions/:id/create-payment-link', userProtect, createRazorpayPaymentLink);
router.get('/submissions/:id/payment-callback', handlePaymentCallback); // Public callback route (called by Razorpay)
...
router.get('/documents/:fileId/download', userProtect, downloadDocument);
