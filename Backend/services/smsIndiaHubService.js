...
/**
 * SMSIndia Hub SMS Service for CreateBharat
...
class SMSIndiaHubService {
  ...
  async sendOTP(phone, otp) {
    try {
      ...
      // Use the exact template that works with SMSIndiaHub (from Chalo Sawari)
  ...
  async testConnection() {
    try {
      ...
      const testMessage = 'Test message from CreateBharat. SMS service is working correctly.';
