...
// File filter for pitch documents (PDF, DOCX, Excel)
const pitchDocumentFilter = (req, file, cb) => {
  const allowedMimes = [
    'application/pdf',
    'application/msword',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
...
const uploadResume = multer({
  storage: storage,
  limits: {
    fileSize: 15 * 1024 * 1024 // 15MB limit for resumes
  },
...
// Configure multer for pitch documents (PDF, DOCX, Excel)
const uploadPitchDocuments = multer({
  storage: storage,
  limits: {
    fileSize: 10 * 1024 * 1024 // 10MB limit for pitch documents
  },
  fileFilter: pitchDocumentFilter
});

// Export all upload middleware and parser
module.exports = upload;
module.exports.uploadResume = uploadResume;
module.exports.uploadCompanyDocuments = uploadCompanyDocuments;
module.exports.uploadLegalDocuments = uploadLegalDocuments;
module.exports.uploadPitchDocuments = uploadPitchDocuments;
